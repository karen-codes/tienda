...
<div class="container-fluid">
    ...
    <form method="POST" action="index.php?action=editar" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nombre" name="nombre" class="form-control" value="<?= htmlspecialchars($_POST['nombre'] ?? $producto['nombre']) ?>" required maxlength="100">
            <?php if (isset($errors['nombre'])): ?><span class="text-danger small mt-1"><?= htmlspecialchars($errors['nombre']) ?></span><?php endif; ?>
        </div>

        <div class="mb-3">
            <label for="precio" class="form-label">Precio:</label>
            <input type="number" id="precio" name="precio" step="0.01" class="form-control" value="<?= htmlspecialchars($_POST['precio'] ?? $producto['precio']) ?>" required min="0.01">
        ...
        <div class="mb-3">
            ...
            <textarea id="descripcion" name="descripcion" rows="5" class="form-control" maxlength="500"><?= htmlspecialchars($_POST['descripcion'] ?? $producto['descripcion']) ?></textarea>
